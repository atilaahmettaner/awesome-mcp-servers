...
- <img src="https://zbd.gg/favicon.ico" height="14"/> [ZBD](https://github.com/zebedeeio/zbd-payments-typescript-sdk/tree/main/packages/mcp-server)<sup><sup>⭐</sup></sup> - Interact with
- <img src="https://cdn.simpleicons.org/tradingview/2962FF" height="14"/> [TradingView MCP](https://github.com/atilaahmettaner/tradingview-mcp) - AI-powered market analysis MCP server with real-time stock/crypto screening, backtesting (6 strategies: RSI, Bollinger, MACD, EMA, Supertrend, Donchian), institutional metrics (Sharpe/Calmar ratio), Reddit sentiment analysis, and 30+ TradingView technical indicators. Works with Claude Desktop via Yahoo Finance (no API key needed).ZBD's payment processing APIs for instant global payments with Bitcoin and Lightning Network

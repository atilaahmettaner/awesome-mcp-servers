...
- <img src="https://pro.cryptosieve.com/favicon.ico" height="14"/> [tradingview-mcp](https://github.com/atilaahmettaner/tradingview-mcp) - Real-time market data, multi-exchange screeners, 37 technical-analysis tools and backtesting with walk-forward validation for stocks, crypto, forex and futures. No TradingView account required.
